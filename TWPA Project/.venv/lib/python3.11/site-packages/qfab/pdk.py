...
from gdsfactory.pdk import GdsWriteSettings
...
LAYER = QFaBLayers()
LAYER_VIEWS = LayerViews(filepath=importlib.resources.files("qfab") / "layermap.yaml")
...
def CPW_open(width: float, gap: float, chip: int = 1):
    slayer = getattr(LAYER, f"SC{chip}_E")
...
default_pdk = gf.Pdk(
    ...
    cross_sections=dict(cpw=CPW(17, 11), open=CPW_open(17, 11)),
    layer_views=LAYER_VIEWS,
    gds_write_settings=GdsWriteSettings(max_points=8_192),
)
